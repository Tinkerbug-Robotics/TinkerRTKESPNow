...
void setup() 
{
    ...
    tft.drawString("Voltage(V):", 3, 24);
    tft.drawString("Current(mA):", 3, 54);
    tft.drawString("Temp(C):", 3, 84);
    tft.drawString("Battery(%):", 3, 114);
...
void readAndSendSOC()
{
    ...
    // Cursor position for printing voltage
    tft.setCursor(115, 24);
    pos_spr.printToSprite(" " + (String)dataForTinkerSend.voltage + " ");
    tft.setCursor(130, 54);
    pos_spr.printToSprite(" " + (String)dataForTinkerSend.avg_current + " ");
    tft.setCursor(100, 84);
    pos_spr.printToSprite(" " + (String)dataForTinkerSend.temperature + " ");
    tft.setCursor(115, 114);
